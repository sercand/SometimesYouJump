   ...
   b2DynamicTree.prototype.RayCast = function (callback, input) {
      ...
      while (count > 0) {
         ...
         if (node.IsLeaf()) {
            ...
            //console.log("Running callback with maxFraction "+maxFraction);
...
(function () {
   ...
   b2PolygonShape.prototype.RayCast = function (output, input, transform) {
      ...
      //console.log("polygon raycast "+input.p1.y+" to "+input.p2.y);
      for (var i = 0; i < this.m_vertexCount; ++i) {
         tVec = this.m_vertices[i];
         tX = tVec.x - p1X;
         tY = tVec.y - p1Y;
         ...
         if (upper < lower - 1.19209290e-7/*Number.MIN_VALUE*/) { //CCTODO
            return false;
         }
      }
      if (index >= 0) {
